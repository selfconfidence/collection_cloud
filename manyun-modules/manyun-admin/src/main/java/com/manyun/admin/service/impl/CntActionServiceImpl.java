...
public class CntActionServiceImpl implements ICntActionService
{
    ...
    {
        return cntActionMapper.selectCntActionList(cntAction).stream().map(m ->{
    ...
    {
        return cntActionMapper.deleteCntActionByIds(ids);
    }
    ...
    {
        return cntActionMapper.deleteCntActionById(id);
    }
}
