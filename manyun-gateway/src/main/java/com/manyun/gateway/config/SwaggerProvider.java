...
import com.manyun.common.core.enums.SwaggerConvetEnum;
...
/*
                        .filter(predicateDefinition -> !"manyun-auth".equalsIgnoreCase(routeDefinition.getId()))
*/
                        .forEach(predicateDefinition -> resourceList
                                .add(swaggerResource(convertName(routeDefinition.getId()), predicateDefinition.getArgs()
