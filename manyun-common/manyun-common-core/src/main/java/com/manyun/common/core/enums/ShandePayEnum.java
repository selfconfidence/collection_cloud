...
public enum ShandePayEnum
{
   ...
   // BOX_SHANDE_PAY("https://dcalliance.com.cn/prod-api/business/notify_pay/ShandePay/boxNotify", "盲盒支付",""),
    ...
    AUCTION_MARGIN_SHANDE_PAY("https://dcalliance.com.cn/prod-api/business/notify_pay/ShandePay/auctionMarginNotify", "保证金支付", ""),
    AUCTION_SHANDE_PAY("https://dcalliance.com.cn/prod-api/business/notify_pay/ShandePay/auctionNotify", "拍卖支付", ""),
    AUCTION_FIX_SHANDE_PAY("https://dcalliance.com.cn/prod-api/business/notify_pay/ShandePay/auctionFixNotify", "一口价支付", "");
